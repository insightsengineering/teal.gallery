...
app <- init(
  ...
  modules = modules(
    tm_front_page(
      label = "App Info",
      header_text = c("Info about input data source" = "This app uses MultiplAssayExperiment data object randomly generated by `scda`, `scda.2022` & `hermes` R packages"), # nolint
